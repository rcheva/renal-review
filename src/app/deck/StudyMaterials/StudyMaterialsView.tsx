...
const getIconForType = (type: string) => {
  switch (type) {
    case "doc":
      return <IconFileText size={24} color="var(--theme-primary-600)" />;
    case "resume":
      return <IconFileDescription size={24} color="var(--theme-primary-600)" />;
    case "ppt":
      return <IconPresentation size={24} color="var(--theme-primary-600)" />;
    case "video":
      return <IconVideo size={24} color="var(--theme-primary-600)" />;
    case "audio":
      return <IconHeadphones size={24} color="var(--theme-primary-600)" />;
    case "table":
      return <IconTable size={24} color="var(--theme-primary-600)" />;
    default:
      return <IconFileText size={24} color="var(--theme-primary-600)" />;
  }
};
