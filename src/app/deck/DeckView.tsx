        ...
        <div className={BASE}>
          ...
          <Tabs defaultValue="subdecks" variant="outline">
            <Tabs.List>
              ...
              <Tabs.Tab value="study-materials">
                Study Materials
                {(deck?.studyMaterials?.length as number) > 0 && (
                  <Badge
                    size="sm"
                    variant="light"
                    color="primary"
            ...
            <Tabs.Panel value="study-materials">
              <StudyMaterialsView deck={deck as Deck} />
            </Tabs.Panel>
          </Tabs>
        </div>
      )}
